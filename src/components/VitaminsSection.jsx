...
export const VitaminsSection = React.memo(function VitaminsSection({ content }) {
  return (
    <section className="scroll-section align-left" data-enter="32" data-leave="44" data-animation="fade-up">
      <div className="section-inner">
        ...
        <div className="s-elem mt-8 flex items-center gap-3 text-sm text-white/75 brand-body font-medium">
          <Check className="text-[#00f0ff]" size={20} />
          <span>{content.subtitle}</span>
        </div>

        <div className="s-elem mt-10 grid grid-cols-2 gap-6 md:gap-8">
        ...
        <p className="s-elem text-[10px] text-white/42 mt-8 uppercase tracking-[0.22em]">{content.disclaimer}</p>
      </div>
    </section>
  );
});
