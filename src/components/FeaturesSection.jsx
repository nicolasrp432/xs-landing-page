...
export const FeaturesSection = React.memo(function FeaturesSection({ content }) {
  return (
    <section className="scroll-section align-right" data-enter="20" data-leave="28" data-animation="clip-reveal">
      <div className="section-inner opacity-100 flex flex-col gap-10 relative">
        <div className="absolute -left-16 top-0 w-px h-32 bg-gradient-to-b from-[#ff007f] to-transparent hidden md:block"></div>
        
        <div className="s-elem brand-chip px-3 py-1 rounded-full w-fit mb-4">
        ...
        <h2 className="s-elem brand-heading text-[clamp(2.8rem,6vw,5.75rem)] text-white drop-shadow-lg leading-tight">
        ...
        <p className="s-elem brand-body text-base md:text-lg text-white/80 font-medium max-w-lg leading-relaxed" dangerouslySetInnerHTML={{ __html: content.description }}></p>
        
        <div className="s-elem flex flex-wrap gap-4 mt-6">
