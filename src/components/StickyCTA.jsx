  ...
  return (
    <div className="fixed bottom-6 right-6 left-[5.5rem] sm:left-auto sm:w-[360px] z-[90] pointer-events-auto">
      <button 
        ...
        <div className="bg-[#16161a]/88 backdrop-blur-xl rounded-[16px] px-6 py-4 flex items-center justify-between group-hover:bg-[#16161a]/72 transition-all border border-white/5">
          <div className="flex flex-col text-left">
            <span className="brand-heading text-white text-lg leading-none">Asegura tu XS</span>
            <span className="text-[#ff8cc0] text-[10px] uppercase tracking-[0.28em] font-semibold mt-1 flex items-center gap-1"><Clock size={10} /> Oferta Limitada</span>
          </div>
